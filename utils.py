...
def get_training_dataloader(path, batch_size=16, num_workers=2, shuffle=True):
    ...
    custom_training = CustomDataset(path, transform=transform_train)
...
def get_test_dataloader(path, batch_size=16, num_workers=2, shuffle=False):
    ...
    custom_test = CustomDataset(path, transform=transform_test)
    custom_test_loader = DataLoader(
        custom_test, shuffle=shuffle, num_workers=num_workers, batch_size=batch_size)

    return custom_test_loader
