...
#####################################
# Tweak Model B: https://arxiv.org/pdf/1812.01187
# Assumption: Improvde the model accuracy by taking more information in path B of the downsampling blocks

# class BasicBlock(nn.Module):
#     """Basic Block for resnet 18 and resnet 34 with ResNet-B tweak
#     """
...
#         #residual function with ResNet-B tweak
#         self.residual_function = nn.Sequential(
...
#         # Input stem with ResNet-C tweak
#         self.conv1 = nn.Sequential(
